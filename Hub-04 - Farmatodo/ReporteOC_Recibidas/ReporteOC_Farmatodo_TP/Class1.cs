...
namespace ReporteOC
{
	...
	class Class1
	{
		...
		#region Clases
		public static ClaseReporteOC objFacturaGenerica = new ClaseReporteOC();
        ...
        static void Main(string[] args)
		{
			...
			try 
			{
				...
				Console.WriteLine("	 ");
				Console.WriteLine("	 ");
				Console.WriteLine("  ------------ IMPORTANDO REPORTE OC '" + Class1.strCliente + "' ------------");
				Console.WriteLine("	 ");
			...
			if (strFileName != "")
			{
				try
				{
					...
					{							
							objFacturaGenerica.InsertReporteOC(strFileName);
		...
		public static void leerArchivoXML(string strUbicacion)
		{
			...
			try
			{
				XmlTextReader reader = new XmlTextReader (strUbicacion);
