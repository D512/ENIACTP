...
namespace TP_CargaTienda
{
	...
	class Class1
	{
		...
		#region Clases
        public static ClaseCargaTienda objCargaCliente = new ClaseCargaTienda();
		...
		static void Main()
		{
			...
			try 
			{
				...
				Console.WriteLine("	 ");
				Console.WriteLine("	 ");
				Console.WriteLine("  ------------ IMPORTANDO ARCHIVO CARGA DE TIENDAS ------------");
				Console.WriteLine("	 ");
			...
			if (strFileName != "")
			{
				try
				{
					...
					{
                        objCargaCliente.InsertCargaTienda(strFileName);
