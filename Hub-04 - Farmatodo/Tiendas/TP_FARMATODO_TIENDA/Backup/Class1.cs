...
namespace TP_CargaCliente
{
	...
	class Class1
	{
		...
		#region Clases
		public static ClaseCargaCliente objCargaCliente = new ClaseCargaCliente();
		...
		static void Main()
		{
			...
			try 
			{
				...
				Console.WriteLine("	 ");
				Console.WriteLine("	 ");
				Console.WriteLine("  ------------ IMPORTANDO ARCHIVO CARGA DE CLIENTES ------------");
				Console.WriteLine("	 ");
			...
			if (strFileName != "")
			{
				try
				{
					...
					{							
							objCargaCliente.InsertCargaCliente(strFileName);
