...
namespace TP_TIENDAS
{
	...
	class Class1
	{
		...
		#region Clases
		public static ClaseTiendas objOrdenCompra = new ClaseTiendas();
		...
		static void Main()
		{
			...
			try 
			{
				...
				Console.WriteLine("	 ");
				Console.WriteLine("	 ");
				Console.WriteLine("  ------------ IMPORTANDO ARCHIVOS TIENDAS FARMATODO ------------");
				Console.WriteLine("	 ");
			...
			if (strFileName != "")
			{
				...
				try
				{
					...
					{
							objOrdenCompra.InsertTiendas(strFileName);
