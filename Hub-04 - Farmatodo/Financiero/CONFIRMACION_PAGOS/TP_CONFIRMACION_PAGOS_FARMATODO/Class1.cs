...
namespace TP_CONFIRMACION_PAGOS
{
	...
	class Class1
	{
		...
		public static string strCampoDet20 = String.Empty;
        public static string strCampoDet21 = String.Empty;
        public static string strCampoDet22 = String.Empty;
        public static string strCampoDet23 = String.Empty;
        public static string strCampoDet24 = String.Empty;
        public static string strCampoDet25 = String.Empty;
		...
		public static ClaseConfirmacionPagos objConfirmacionPagos = new ClaseConfirmacionPagos();
		...
		static void Main()
		{
			...
			try 
			{
				...
				Console.WriteLine("	 ");
				Console.WriteLine("  ------------ CARGA CONFIRMACION PAGOS - FARMATODO VE (HUB-04) ------------");
				Console.WriteLine("	 ");
			...
			if (strFileName != "")
			{
				...
				{			
					...
					{						
						//ARCHIVO DE PAGOS
                        objConfirmacionPagos.InsertConfirmacionPagos(strFileName);
			...
			try
			{
				...
				while (reader.Read())
				{
					if(reader.AttributeCount > 0)
					{
						...
						if (reader.GetAttribute(0) == "STRCAMPODET20")
						{
						    strCampoDet20 = reader.GetAttribute(1);
						}
                        if (reader.GetAttribute(0) == "STRCAMPODET21")
                        {
                            strCampoDet21 = reader.GetAttribute(1);
                        }
                        if (reader.GetAttribute(0) == "STRCAMPODET22")
                        {
                            strCampoDet22 = reader.GetAttribute(1);
                        }
                        if (reader.GetAttribute(0) == "STRCAMPODET23")
                        {
                            strCampoDet23 = reader.GetAttribute(1);
                        }
                        if (reader.GetAttribute(0) == "STRCAMPODET24")
                        {
                            strCampoDet24 = reader.GetAttribute(1);
                        }
                        if (reader.GetAttribute(0) == "STRCAMPODET25")
                        {
                            strCampoDet25 = reader.GetAttribute(1);
                        }
