...
namespace TP_RETENCIONARCV
{
	...
	class Class1
	{
		...
		public static ClaseRetencionArcv objRetencionArcv = new ClaseRetencionArcv();
		...
		static void Main()
		{
			...
			try 
			{
				...
				Console.WriteLine("	 ");
				Console.WriteLine("  ------------ CARGA RETENCION ARCV - FARMATODO VE (HUB-04) ------------");
				Console.WriteLine("	 ");
			...
			if (strFileName != "")
			{
				...
				{			
					...
					{						
						//ARCHIVO DE PAGOS
                        objRetencionArcv.InsertRetencionArcv(strFileName);
