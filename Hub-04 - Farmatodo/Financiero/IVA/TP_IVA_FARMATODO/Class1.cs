...
namespace TP_RETENCIONIVA
{
	...
	class Class1
	{
        ...
        public static string strCampoEnc20 = String.Empty;
		...
		public static ClaseRetencionIva objRetencionIva = new ClaseRetencionIva();
		...
		static void Main()
		{
			...
			try 
			{
				...
				Console.WriteLine("	 ");
				Console.WriteLine("  ------------ CARGA RETENCION IVA - FARMATODO VE (HUB-04) ------------");
				Console.WriteLine("	 ");
			...
			if (strFileName != "")
			{
				...
				{			
					...
					{						
						//ARCHIVO DE PAGOS
                        objRetencionIva.InsertRetencionIva(strFileName);
			...
			try
			{
				...
				while (reader.Read())
				{
					if(reader.AttributeCount > 0)
					{
                        ...
                        if (reader.GetAttribute(0) == "STRCAMPOENC20")
                        {
                            strCampoEnc20 = reader.GetAttribute(1);
                        }
