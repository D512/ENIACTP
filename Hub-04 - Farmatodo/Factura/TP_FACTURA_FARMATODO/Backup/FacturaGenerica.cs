							...
							else
							{
								...
								try
								{
									if(arrCamposLinea.GetValue(7).ToString().Trim() == "")
									{
										...
										strEmailCuerpo+= "<br>";
										strEmailCuerpo+= "-ENCABEZADO Factura N° " + strNumeroDoc + ": Campo(8) Descuento General (%). Viene vacio y es un campo requerido.";
										strErrorEncabezados = "SI";
										ErrorTipoRegistro = "SI";
										strEnvioCorreo="SI";
									}
								...
								try
								{
									if(arrCamposLinea.GetValue(8).ToString().Trim() == "")
									{
										...
										strEmailCuerpo+= "<br>";
										strEmailCuerpo+= "-ENCABEZADO Factura N° " + strNumeroDoc + ": Campo(9) Descuento General (Bs.F.). Viene vacio y es un campo requerido.";
										strErrorEncabezados = "SI";
										ErrorTipoRegistro = "SI";
										strEnvioCorreo="SI";
									}
								...
								try
								{
									if(arrCamposLinea.GetValue(15).ToString().Trim() == "")
									{
										...
										strEmailCuerpo+= "<br>";
										strEmailCuerpo+= "-ENCABEZADO Factura N° " + strNumeroDoc + ": Campo(16) Monto Total Descuento Adicional. Viene vacio y es un campo requerido.";
										strErrorEncabezados = "SI";
										ErrorTipoRegistro = "SI";
										strEnvioCorreo="SI";
									}
