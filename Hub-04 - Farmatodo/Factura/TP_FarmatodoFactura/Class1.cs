...
namespace Factura
{
	...
	class Class1
	{
		...
		public static string strLogErrorFile="";//RUTA DEL ARCHIVO LOG ERROR
		public static string strEmailFile="";//RUTA DEL ARCHIVO MAIL
		public static string strEscrituraLog = String.Empty;
		public static string strEscrituraLogError = String.Empty;
		...
		public static ClaseFactura objFactura=new ClaseFactura();//OBJETO DE LA CLASE QUE HACE EL PROCESO DE CARGA DE LOS STATUS DE PEDIDO
		...
		static void Main()
		{
			try 
			{
				...
				Console.WriteLine("	 ");
				Console.WriteLine("	 ");
				Console.WriteLine("  ------------ IMPORTANDO FACTURAS ------------");
				Console.WriteLine("	 ");
				...
				try
				{
					...
					if (File.Exists(strFileName))
					{
					    try
						{
						 ...
						 objFactura.InsertFactura(strFileName);
						 Class1.objTextFile.EscribirLog("HA FINALIZADO EL PROCESO DE IMPORT DE LAS FACTURAS DEL ARCHIVO PLANO DE ENTRADA: " + strFileName);
						}
						catch(Exception e)
						{
							objTextFile.EscribirLog("ERROR AL CARGAR LAS FACTURAS DEL ARCHIVO PLANO: "+strFileName);
		...
		}//FIN DEL METODO DE INSERCION DE FACTURAS
